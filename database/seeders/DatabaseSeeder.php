...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //     ['user_id' => $users[2]->id, 'type' => 'VRIDE',  'created_at' => $timestamp, 'updated_at' => $timestamp],
        //     ['user_id' => $users[3]->id, 'type' => 'AGENT',  'created_at' => $timestamp, 'updated_at' => $timestamp],
        //     ['user_id' => $users[4]->id, 'type' => 'DEALER',  'created_at' => $timestamp, 'updated_at' => $timestamp],
        // ]);
        // $pudoIds = DB::table('pudos')->pluck('id', 'type');
        // $rideTypeIds = DB::table('v_ride_types')->pluck('id', 'slug');

        // $rideDefinitions = [
        //     ['type' => 'motorcycle', 'pudo' => 'VENDOR', 'status' => 'pending'],
        //     ['type' => 'tricycle', 'pudo' => 'ERRAND', 'status' => 'approved', 'approved_at' => $timestamp],
        //     ['type' => 'compact-car', 'pudo' => 'VRIDE', 'status' => 'active', 'approved_at' => $timestamp],
        //     ['type' => 'suv', 'pudo' => 'AGENT', 'status' => 'suspended', 'suspended_at' => $timestamp, 'suspension_reason' => 'Insurance documents require renewal.'],
        //     ['type' => 'pickup-truck', 'pudo' => 'DEALER', 'status' => 'rejected'],
        // ];
